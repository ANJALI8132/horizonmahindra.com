...
if (isset($_POST['submit']) and !empty($_POST['submit'])) {
    ...
    $complete = mail("viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, dem@horizonmahindra.com, sm.ktmservice@horizonmahindra.com, leads.viralmafia@gmail.com", $mail1_subject, $mail1_txt, $headers);
...
if (isset($_POST['insurance_submit']) and !empty($_POST['insurance_submit'])) {
    ...
    $complete = mail("viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, dem@horizonmahindra.com, horizonservice12@gmail.com, leads.viralmafia@gmail.com", $mail1_subject, $mail1_txt, $headers);
...
if (isset($_POST['submit360']) and !empty($_POST['submit360'])) {
    ...
    $complete = mail("viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, dem@horizonmahindra.com, horizonservice12@gmail.com, sm.ktmservice@horizonmahindra.com, leads.viralmafia@gmail.com", $mail1_subject, $mail1_txt, $headers);
...
if(in_array($ext,$allowed) ) {
    ...
    $to = "viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, dem@horizonmahindra.com, sm.ktmservice@horizonmahindra.com, hr@horizonmahindra.com, leads.viralmafia@gmail.com";
...
if (isset($_POST['getloan']) and !empty($_POST['getloan'])) {
    ...
    $complete = mail("viralmafiacs2@gmail.com, cyril.viralmafia@gmail.com, dem@horizonmahindra.com, leads.viralmafia@gmail.com, leads.viralmafia@gmail.com", $mail1_subject, $mail1_txt, $headers);
...
if (isset($_POST['bookservices']) and !empty($_POST['bookservices'])) {
    $qname = $_POST['name'];
    $qphone = $_POST['mobile_no'];
    $car_no = $_POST['car_no'];
    $service_type = $_POST['service_type'];
    $kilometer_done = $_POST['kilometer_done'];
    $model_id = $_POST['model_id'];
    $service_date = $_POST['service_date'];
    $service_time = $_POST['service_time'];

    $mail1_subject = "Service Enquiry from Horizon Mahindra - " . $qname;
    $mail1_txt = "Name :" . $qname . "<br>" . "Mobile :" . $qphone . "<br>" . "Car No :" . $car_no . "<br>" . "Service Type :" . $service_type . "<br>" . "Kilometer :" . $kilometer_done . "<br>" . "Model :" . $model_id . "<br>" . "Service Date :" . $service_date . "<br>" . "Service Time :" . $service_time . "<br>";
